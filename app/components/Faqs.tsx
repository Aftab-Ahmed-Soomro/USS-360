    ...
    <section className="relative z-10 bg-black px-6 py-20 text-white  lg:py-[100px]">
      <div className="mx-auto flex min-h-[557px] max-w-[1150px] flex-col gap-16">
        ...
        <div className="border-t border-white/20">
          {faqs.map((faq) => (
            <button
              className="flex min-h-[105px] w-full items-center justify-between gap-8 border-b border-white/[0.06] py-8 text-left"
              key={faq}
              type="button"
            >
              ...
              <span className="grid size-10 shrink-0 place-items-center rounded-full border border-[#1a1a1a] font-[var(--font-be-vietnam)] text-[20px] leading-7 text-[#1a1a1a]">
                +
              </span>
            </button>
          ))}
